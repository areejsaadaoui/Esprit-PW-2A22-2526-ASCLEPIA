...
$payload = json_encode([
    ...
    'messages' => [
        [
            'role' => 'system', 
            'content' => 'Tu es un assistant qui corrige les fautes d\'orthographe et de grammaire en français ou en anglais ou en arabe ou en darija selon le besoin. Tu ne fais que corriger le texte, sans ajouter d\'explications, sans changer le sens, sans ajouter de contenu. Tu réponds UNIQUEMENT avec le texte corrigé.'
        ],
        [
            'role' => 'user', 
