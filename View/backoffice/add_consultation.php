...
<head>
    ...
    <style>
        ...
        .btn-save { background-color: #27ae60; font-size: 15px; }
...
<form id="consultationForm" method="POST" onsubmit="return validerFormulaire()">
    ...
    <textarea name="diagnostique" id="diagnostique" placeholder="Entrez le diagnostique..." oninput="compter('diagnostique', 'count_diag', 10)"></textarea>
    <div class="counter"><span id="count_diag">0</span> caractères</div>
    ...
    <textarea name="notes" id="notes" placeholder="Entrez les notes..." oninput="compter('notes', 'count_notes', 5)"></textarea>
    <div class="counter"><span id="count_notes">0</span> caractères</div>
...
<script>
    ...
    // Définir la date maximum = maintenant
    const maintenant = new Date();
